...
var selenium = require('selenium-sauce');
...
function (browser) {
  ...
  browser.init(function(err) {
    ...
    browser.url('http://google.com', function() {

      test.equal({}, browser, 'Browser object dump');

      test.equal({}, arguments, 'arguments dump');

      // Tell SauceLabs that the test was successful
      browser.report(true, function report() {
        test.equal({}, arguments, 'report arguments dump');
      });
    });
  });
});
